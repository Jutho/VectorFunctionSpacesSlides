...
* **Traagheidswet van Sylvester**: Twee symmetrische matrices $\mat{B},\mat{\tilde{B}} \in \bbR^{n \times n}$ zijn congruent als en slachts als hetzelfde aantal positieve, negatieve en nul eigenwaarden hebben.
...
* voor inverteerbare (en dus vierkante) $\mat{A}\in\bbF^{n \times n}$: $\mat{A}^{-1} = \mat{V} \mat{S}^{-1} \mat{U}^\hermitian$
